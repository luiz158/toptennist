 ...
 */
package com.robsonximenes.toptennist.exception;

import br.gov.frameworkdemoiselle.exception.ApplicationException;
import br.gov.frameworkdemoiselle.message.SeverityType;

import com.robsonximenes.toptennist.util.BundleUtil;

@ApplicationException(rollback = true, severity = SeverityType.ERROR)
public class FalhaNoLoginException extends RuntimeException {

	private static final long serialVersionUID = 1L;

	public FalhaNoLoginException() {
		super(BundleUtil.getBundle().getString("usuario.exception.login.falha"));
	}
}
